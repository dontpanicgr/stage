    ...
    <div class="container">
      <div class="navbar-brand">
        <div class="navbar-item">
          <router-link :to="$i18nRoute({ name: 'home'})" exact class="brand">
            ...
            <div class="brand-content">
              <div class="brand-title is-top"> {{ $t("brand.title") }} </div>
              <div class="brand-subtitle is-top"> {{ $t("brand.subtitle") }}</div>
            </div>
          </router-link>
        </div>
        <!-- Small Nav -->
        <div class="mobile-menu-simple is-marginless is-hidden-desktop">
          ...
          <a href="/login" target="_blank" class="navbar-item button is-dark is-transparent">{{ $t("nav.go-mobile") }}</a>
        </div>
      </div>
      <!-- Normal Nav -->
      <div class="navbar-menu">
        <div class="navbar-end">
            <a href="/login" target="_blank" class="button is-dark is-transparent">{{ $t("nav.go") }}</a>
